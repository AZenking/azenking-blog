...
description: '对比 Fetch API 的 credentials 与 Axios/XMLHttpRequest 的 withCredentials，说明跨域请求中 Cookie、认证信息和 CORS 配置的差异。'
pubDate: 2025-01-16
author: 'Ethan Yang'
comment: true
toc: true
...
最近在做 SSE 功能优化时，将项目中原生的 [EventSource](https://developer.mozilla.org/zh-CN/docs/Web/API/EventSource) 替换为 [@microsoft/fetch-event-source](https://github.com/Azure/fetch-event-source)

由于 @microsoft/fetch-event-source 使用 fetch API, 而原生的 EventSource 使用 XMLHttpRequest

![credentials vs withCredentials](./assets/6788aded4123d.png)
