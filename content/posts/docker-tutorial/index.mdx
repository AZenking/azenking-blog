---
title: '写给前端的 Docker 入门：从概念到 Compose 实战'
description: '面向前端开发者整理 Docker 入门知识，覆盖镜像、容器、Dockerfile、常用命令和本地开发部署中需要理解的基础概念。'
pubDate: 2024-05-06
author: 'Ethan Yang'
tags: ['Docker', 'DevOps']
postType: 'article'
...
![Untitled.jpeg](assets/docker-diagram.jpeg)
