---
title: '一个 undefined 让我排查了两天：前端循环依赖排查实录'
description: '记录在 JavaScript 项目中引入循环依赖导致 undefined 错误的排查过程，分析模块加载顺序、依赖方向和可落地的重构方案。'
pubDate: 2025-06-04
tags: ['javascript', 'debug', '循环依赖']
---
...
```jsx
import { SinopecCompService } from '@/pages/cashRegister/ThirdPlatformService/SinopecCompService'
...
![CleanShot_2025-06-09_at_10.06.10.png](./images/6846f96863ce6.png)
...
![CleanShot_2025-06-09_at_10.27.13.png](./images/6846f96b344bf.png)
...
![CleanShot_2025-06-09_at_11.48.28.png](./images/6846f967d4fdd.png)
